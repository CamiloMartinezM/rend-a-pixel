...
{
    /**
     * @brief Generates random numbers uniformely distributed in [0,1), which are all stochastically independent from
     * another. This is the simplest form of random number generation, and will be sufficient for our introduction to
     * Computer Graphics. If you want to reduce the noise in your renders, a simple way is to implement more
     * sophisticated random numbers (e.g., jittered sampling or blue noise sampling).
