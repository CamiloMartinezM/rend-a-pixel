...
// Forward declaration of Hashing and Permutation utility functions
...
template <typename T, typename... Args> inline void hashRecursiveCopy(char *buf, T v, Args... args)
{
